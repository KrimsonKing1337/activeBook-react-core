...
var Bookmarks = function () {
    ...
    return ((0, jsx_runtime_1.jsxs)(Overflow_1.Overflow, { id: "bookmarks", isOpen: isOpen, children: [(0, jsx_runtime_1.jsx)(Header_1.Header, { label: "\u0417\u0430\u043A\u043B\u0430\u0434\u043A\u0438" }), (0, jsx_runtime_1.jsx)("div", { className: Bookmarks_scss_1.default.itemsWrapper, children: bookmarks.map(function (itemCur, index) {
                    return ((0, jsx_runtime_1.jsx)(Item_1.Item, { pageNumber: itemCur, onDelete: deleteHandler }, index));
                }) }), (0, jsx_runtime_1.jsxs)("div", { className: Bookmarks_scss_1.default.footer, children: [(0, jsx_runtime_1.jsx)("button", { className: buttonAddClassNames, onClick: addButtonClickHandler, children: "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C" }), (0, jsx_runtime_1.jsx)("button", { className: Bookmarks_scss_1.default.button, onClick: closeButtonClickHandler, children: "\u0417\u0430\u043A\u0440\u044B\u0442\u044C" })] })] }));
};
