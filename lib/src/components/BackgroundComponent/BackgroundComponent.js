...
var BackgroundComponent = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: wrapperClassName }, etc, { style: { backgroundColor: shadowColor }, children: [children && withShadow && ((0, jsx_runtime_1.jsx)("div", { className: BackgroundComponent_scss_1.default.shadow })), children] })));
};
