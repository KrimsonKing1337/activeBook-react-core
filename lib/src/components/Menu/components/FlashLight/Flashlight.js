        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!!flashlight_2.flashlightInst.isInited) return [3 /*break*/, 4];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, flashlight_2.flashlightInst.init()];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
