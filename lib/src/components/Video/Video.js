...
var Video = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("video", __assign({ ref: ref, "data-id": id, "data-autoPlay": autoPlay, className: className, src: src, preload: "auto", poster: "/assets/img/poster-default.png", muted: muted }, etc)));
};
exports.Video = Video;
