...
var App = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(store_1.StoreProvider, { children: (0, jsx_runtime_1.jsx)(rr6_1.HistoryRouter, { history: store_1.history, children: (0, jsx_runtime_1.jsx)(AppWrapper_1.AppWrapper, { rangeEffectsJson: rangeEffectsJson, children: (0, jsx_runtime_1.jsx)(Routes_1.Routes, { children: children }) }) }) }));
};
exports.App = App;
