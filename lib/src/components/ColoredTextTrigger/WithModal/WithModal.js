...
var WithModal = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("span", { className: WithModal_scss_1.default.wrapper, ref: wrapperRef, children: [(0, jsx_runtime_1.jsx)(Modal_1.Modal, { isOpen: isActive, onClose: function () { return setIsActive(false); }, mode: mode, canCrop: true, cropDefault: false, canFullScreen: true, children: children }), trigger] }));
};
