...
var AuthorComment = function (_a) {
    ...
    return showComment ? ((0, jsx_runtime_1.jsxs)("span", __assign({ className: AuthorComment_scss_1.default.authorComment, onClick: clickHandler }, props, { children: [' ', children] }))) :
