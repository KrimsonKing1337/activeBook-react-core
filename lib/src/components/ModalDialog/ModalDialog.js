...
var ModalDialog = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(Modal_1.Modal, __assign({ isOpen: isOpen, canClose: canClose, onClose: closeHandler }, etc, { children: (0, jsx_runtime_1.jsxs)("div", { className: ModalDialog_scss_1.default.wrapper, children: [(0, jsx_runtime_1.jsx)("div", { className: "ModalDialogDesc", children: children }), (0, jsx_runtime_1.jsxs)("div", { className: ModalDialog_scss_1.default.actions, children: [showConfirmButton && ((0, jsx_runtime_1.jsx)(Button_1.Button, { type: "success", disabled: !canClose, onClick: confirmButtonClickHandler, children: confirmBtnLabel })), showCancelButton && ((0, jsx_runtime_1.jsx)(Button_1.Button, { type: "secondary", disabled: !canClose, onClick: cancelButtonClickHandler, children: cancelBtnLabel }))] })] }) })));
};
