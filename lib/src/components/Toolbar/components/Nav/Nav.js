...
import { Item } from '../../../Toolbar/components/Item';
...
export var Nav = function () {
    var _a, _b;
    var _c = useGoToPage(), goToPage = _c.goToPage, goPrevPage = _c.goPrevPage, goNextPage = _c.goNextPage;
    var page = useSelector(mainSelectors.page);
    var pages = useSelector(mainSelectors.pages);
    var inputRef = useRef(null);
    var _d = useState(true), goToWithInputIsHide = _d[0], setGoToWithInputIsHide = _d[1];
