...
var Toolbar = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { id: "toolbar", className: Toolbar_scss_1.default.wrapper, children: (0, jsx_runtime_1.jsxs)("div", { className: Toolbar_scss_1.default.toolbar, children: [!sbMode && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Item_1.Item, { "data-welcome-tour-id": "bookmarks", onClick: bookmarkClickHandler, children: (0, jsx_runtime_1.jsx)(i_bookmark_svg_1.default, {}) }), (0, jsx_runtime_1.jsx)(Item_1.Item, { "data-welcome-tour-id": "navigation", children: (0, jsx_runtime_1.jsx)(Nav_1.Nav, {}) })] })), (0, jsx_runtime_1.jsxs)("div", { "data-welcome-tour-id": "font", className: Toolbar_scss_1.default.fontSizeControlWrapper, children: [(0, jsx_runtime_1.jsx)(Item_1.Item, { onClick: fontSmallClickHandler, children: (0, jsx_runtime_1.jsx)(i_font_small_svg_1.default, {}) }), (0, jsx_runtime_1.jsx)(Item_1.Item, { onClick: fontBigClickHandler, children: (0, jsx_runtime_1.jsx)(i_font_big_svg_1.default, {}) })] }), (0, jsx_runtime_1.jsx)(Item_1.Item, { "data-welcome-tour-id": "config", onClick: etcIconClickHandler, children: (0, jsx_runtime_1.jsx)(i_etc_svg_1.default, {}) })] }) }));
};
