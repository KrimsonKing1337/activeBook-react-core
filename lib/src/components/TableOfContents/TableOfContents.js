...
var TableOfContents = function () {
    ...
    return ((0, jsx_runtime_1.jsxs)(Overflow_1.Overflow, { id: "table-of-contents", isOpen: isOpen, children: [(0, jsx_runtime_1.jsx)(Header_1.Header, { label: "\u041E\u0433\u043B\u0430\u0432\u043B\u0435\u043D\u0438\u0435" }), (0, jsx_runtime_1.jsx)("div", { className: TableOfContents_scss_1.default.itemsWrapper, children: utils_1.items.map(function (itemCur, index) { return (0, jsx_runtime_1.jsx)(Item_1.Item, __assign({}, itemCur), index); }) }), (0, jsx_runtime_1.jsx)("button", { className: TableOfContents_scss_1.default.button, onClick: closeButtonClickHandler, children: "\u0417\u0430\u043A\u0440\u044B\u0442\u044C" })] }));
};
