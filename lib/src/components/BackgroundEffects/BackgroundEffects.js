...
var BackgroundEffects = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: BackgroundEffects_scss_1.default.backgroundEffectsWrapper, children: [dotsIsActive && ((0, jsx_runtime_1.jsx)(Dots_1.Dots, {})), oneOfBgIsActive && ((0, jsx_runtime_1.jsxs)("div", { className: BackgroundEffects_scss_1.default.backgroundObjectsWrapper, children: [(0, jsx_runtime_1.jsx)("div", { className: BackgroundEffects_scss_1.default.backgroundObjectsShadow, style: { backgroundImage: shadowColor } }), backgroundVideoIsActive && ((0, jsx_runtime_1.jsx)("div", { className: BackgroundEffects_scss_1.default.backgroundObjectWrapper, children: (0, jsx_runtime_1.jsx)(Video_1.Video, { src: backgroundVideoSrc, autoPlay: true, loop: true, muted: true }) })), backgroundImgIsActive && ((0, jsx_runtime_1.jsx)("div", { className: BackgroundEffects_scss_1.default.backgroundObjectWrapper, children: (0, jsx_runtime_1.jsx)(Img_1.Img, { src: backgroundImgSrc }) }))] }))] }));
};
