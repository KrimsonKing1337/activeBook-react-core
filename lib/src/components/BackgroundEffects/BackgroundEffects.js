...
var BackgroundEffects = function () {
    ...
    return Object.keys(effects).map(function (keyCur) {
        ...
        return ((0, jsx_runtime_1.jsxs)("div", { style: style, className: BackgroundEffects_scss_1.default.backgroundEffectsWrapper, children: [(0, jsx_runtime_1.jsx)(components_1.Dots, {}), oneOfBgIsActive && ((0, jsx_runtime_1.jsxs)("div", { className: BackgroundEffects_scss_1.default.backgroundObjectsWrapper, children: [(0, jsx_runtime_1.jsx)(components_1.Shadow, { options: shadow }), Component, (0, jsx_runtime_1.jsx)(components_1.Videos, { videos: videos }), (0, jsx_runtime_1.jsx)(components_1.Images, { images: images })] }))] }, uuid));
    });
};
