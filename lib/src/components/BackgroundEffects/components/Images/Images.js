...
var Images = function (_a) {
    ...
    return images.map(function (imageCur) {
        ...
        return ((0, jsx_runtime_1.jsx)(Wrapper_1.Wrapper, { style: wrapperStyle, children: (0, jsx_runtime_1.jsx)(Img_1.Img, { passedRef: ref, style: style, className: Images_scss_1.default.img, src: src }) }, uuid));
    });
};
