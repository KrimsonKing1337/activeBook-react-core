...
var Videos = function (_a) {
    ...
    return videos.map(function (videoCur) {
        ...
        return ((0, jsx_runtime_1.jsx)(Wrapper_1.Wrapper, { style: wrapperStyle, children: (0, jsx_runtime_1.jsx)(Video_1.Video, { style: style, className: Videos_scss_1.default.video, src: src, autoPlay: autoPlay, loop: loop, muted: muted, defaultVolume: defaultVolume }) }, uuid));
    });
};
