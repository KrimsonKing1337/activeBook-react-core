...
var Videos = function (_a) {
    ...
    return videos.map(function (videoCur) {
        ...
        return ((0, jsx_runtime_1.jsx)(Video_1.Video, { id: id, style: style, className: Videos_scss_1.default.video, src: src, autoPlay: autoPlay, loop: loop, muted: muted, relativeVolume: relativeVolume }));
    });
};
