...
export var AppWrapper = function (_a) {
    ...
    // применяю конфиг
    useEffect(function () {
        var pages = config.pages, defaultTheme = config.defaultTheme, customThemes = config.customThemes, _a = config.easterEggs, easterEggs = _a === void 0 ? 0 : _a, _b = config.authorComments, authorComments = _b === void 0 ? 0 : _b;
    ...
    */
    ...
    useEffect(function () {
        seenPages.set(page);
        if (page === pages) {
            toast.success('Все страницы прочитаны! Теперь вы можете включить комментарии автора в настройках', {
                onOpen: function () {
