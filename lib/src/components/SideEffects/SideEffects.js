...
var SideEffects = function () {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { id: "side-effects", className: SideEffects_scss_1.default.sideEffects, children: [sideShadowIsActive && ((0, jsx_runtime_1.jsx)(SideShadow_1.SideShadow, {})), sideTextIsActive && ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: sideShadowTemplate }))] }));
};
