...
var Segment_1 = require("../../components/Segment");
...
var Page0 = function (_a) {
    ...
    var _d = (0, react_1.useState)(false), isWelcomeTourModalActive = _d[0], setIsWelcomeTourModalActive = _d[1];
    var _e = (0, react_1.useState)(false), showWelcomeTour = _e[0], setShowWelcomeTour = _e[1];
    var _f = (0, react_1.useState)(0), welcomeTourIdIndex = _f[0], setWelcomeTourIdIndex = _f[1];
    var _g = (0, react_1.useState)('Далее'), welcomeTourNextButtonLabel = _g[0], setWelcomeTourNextButtonLabel = _g[1];
    var _h = (0, hooks_1.useModal)(), modalIsActive = _h.modalIsActive, modalOnClose = _h.modalOnClose, setModalIsActive = _h.setModalIsActive;
    var _j = (0, vibration_1.useVibration)(), vibrationOn = _j.vibrationOn, vibrationOff = _j.vibrationOff;
    ...
    var welcomeTourText = (0, utils_1.getWelcomeTourTextById)(welcomeTourTextId);
    return ((0, jsx_runtime_1.jsxs)(PageWrapper_1.PageWrapper, { children: [(0, jsx_runtime_1.jsx)(ModalDialog_1.ModalDialog, { isOpen: isWelcomeTourModalActive, onClose: welcomeTourModalCloseHandler, onConfirm: welcomeTourModalCloseHandler, onCancel: welcomeTourModalCloseHandler, canFullScreen: false, showCancelButton: false, cantCloseIn: 2000, children: (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("header", { children: "\u041F\u0435\u0440\u0435\u0434 \u0442\u0435\u043C \u043A\u0430\u043A \u043D\u0430\u0447\u043D\u0451\u043C..." }), (0, jsx_runtime_1.jsx)("article", { children: (0, jsx_runtime_1.jsx)("p", { children: "\u041F\u043E\u0437\u043D\u0430\u043A\u043E\u043C\u044C\u0442\u0435\u0441\u044C \u0441 \u0432\u043E\u0437\u043C\u043E\u0436\u043D\u043E\u0441\u0442\u044F\u043C\u0438 \u043A\u043D\u0438\u0433\u0438" }) })] }) }), (0, jsx_runtime_1.jsx)(ModalDialog_1.ModalDialog, { isOpen: modalIsActive, onClose: modalCloseHandler, onConfirm: modalCloseHandler, onCancel: modalCloseHandler, canFullScreen: true, showCancelButton: false, cantCloseIn: 5000, children: (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("header", { children: "\u041E\u0411\u0420\u0410\u0422\u0418\u0422\u0415 \u0412\u041D\u0418\u041C\u0410\u041D\u0418\u0415" }), (0, jsx_runtime_1.jsxs)("article", { children: [(0, jsx_runtime_1.jsx)("p", { children: "\u0414\u043B\u044F \u0440\u0430\u0431\u043E\u0442\u044B \u044D\u0444\u0444\u0435\u043A\u0442\u043E\u0432 \u043D\u0430 \u043E\u0441\u043D\u043E\u0432\u0435 \u0432\u0441\u043F\u044B\u0448\u043A\u0438, \u043F\u0440\u0438\u043B\u043E\u0436\u0435\u043D\u0438\u044E \u043D\u0435\u043E\u0431\u0445\u043E\u0434\u0438\u043C\u043E \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u0440\u0430\u0437\u0440\u0435\u0448\u0435\u043D\u0438\u0435 \u043A \u043A\u0430\u043C\u0435\u0440\u0435 (\u043A \u0441\u043E\u0436\u0430\u043B\u0435\u043D\u0438\u044E, \u043D\u0435\u0442 \u0432\u043E\u0437\u043C\u043E\u0436\u043D\u043E\u0441\u0442\u0438 \u0437\u0430\u043F\u0440\u043E\u0441\u0438\u0442\u044C \u0440\u0430\u0437\u0440\u0435\u0448\u0435\u043D\u0438\u0435 \u0442\u043E\u043B\u044C\u043A\u043E \u043A\u043E \u0432\u0441\u043F\u044B\u0448\u043A\u0435)." }), (0, jsx_runtime_1.jsx)("p", { children: "\u0412\u044B \u0432\u0441\u0435\u0433\u0434\u0430 \u043C\u043E\u0436\u0435\u0442\u0435 \u0437\u0430\u043F\u0440\u043E\u0441\u0438\u0442\u044C \u0440\u0430\u0437\u0440\u0435\u0448\u0435\u043D\u0438\u0435 \u0435\u0449\u0451 \u0440\u0430\u0437, \u0432 \u043C\u0435\u043D\u044E \u043F\u0440\u0438\u043B\u043E\u0436\u0435\u043D\u0438\u044F" })] })] }) }), header && ((0, jsx_runtime_1.jsx)("header", { children: header })), subHeader && ((0, jsx_runtime_1.jsx)("article", { children: subHeader })), showButton && !showWelcomeTour && ((0, jsx_runtime_1.jsx)(Action_1.Action, { fullWidth: true, onClick: clickHandler, children: label })), showWelcomeTour && ((0, jsx_runtime_1.jsxs)("div", { style: { marginTop: '50px', padding: '20px', border: '1px var(--main) solid', borderRadius: '10px' }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { marginBottom: '50px', paddingBottom: '10px', borderBottom: '1px #eaeaea solid' }, children: [(0, jsx_runtime_1.jsx)("p", { children: (0, jsx_runtime_1.jsx)("b", { children: welcomeTourText.header }) }), (0, jsx_runtime_1.jsx)("p", { children: welcomeTourText.article }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: { marginTop: '22px' }, className: "buttonConfirm", onClick: welcomeTourNextButtonClickHandler, children: welcomeTourNextButtonLabel })] }), (0, jsx_runtime_1.jsx)("div", { "data-welcome-tour-id": "action", style: { marginBottom: '50px' }, children: (0, jsx_runtime_1.jsx)(Action_1.Action, { fullWidth: true, onClick: welcomeTourActionClickHandler, children: "\u0412\u044B\u0434\u0435\u043B\u0435\u043D\u043D\u044B\u0439 \u0442\u0435\u043A\u0441\u0442" }) }), (0, jsx_runtime_1.jsxs)("div", { "data-welcome-tour-id": "segments", children: [(0, jsx_runtime_1.jsx)(Segment_1.Segment, { onEnter: segment1EnterHandler, onExit: segment1ExitHandler, children: (0, jsx_runtime_1.jsx)("p", { children: "\u041D\u0430\u0436\u043C\u0438 \u043D\u0430 \u043C\u0435\u043D\u044F" }) }), (0, jsx_runtime_1.jsx)(Segment_1.Segment, { onEnter: segment2EnterHandler, onExit: segment2ExitHandler, children: (0, jsx_runtime_1.jsx)("p", { children: "\u0418 \u043D\u0430 \u043C\u0435\u043D\u044F \u043D\u0430\u0436\u043C\u0438!" }) })] })] })), Footer && ((0, jsx_runtime_1.jsx)(Footer, {}))] }));
};
exports.Page0 = Page0;
