...
var Page0 = function (_a) {
    ...
    var isWelcomeTourActiveFromConfig = (0, store_1.useSelector)(config_1.configSelectors.welcomeTour);
    ...
    var go = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!flashlight_1.flashlightInst.isInited) return [3 /*break*/, 4];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
    ...
    var actionClickHandler = function () {
        ...
        if (!isModalWasShowed && !flashlight_1.flashlightInst.isInited) {
