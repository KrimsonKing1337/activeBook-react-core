...
var unloadAudio_1 = require("../../../../utils/effects/audio/unloadAudio");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, effects_1.put)(slice_1.actions.setIsDeleting(true))];
            case 2:
                _a.sent();
                ...
                if (!howlInstance.isUnloading) {
                    (0, unloadAudio_1.unloadAudio)(howlInstance);
                }
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.put)(slice_1.actions.setIsDeleting(false))];
            case 4:
                _a.sent();
                return [2 /*return*/];
        }
