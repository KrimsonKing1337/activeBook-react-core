...
export declare function watchSetPage(action: PayloadAction<State['page']>): Generator<Promise<unknown[]> | import("redux-saga/effects").PutEffect<import("redux-first-history/build/es6/actions").CallHistoryMethodAction<[to: import("history").To, state?: any]>> | import("redux-saga/effects").PutEffect<{
    payload: boolean;
