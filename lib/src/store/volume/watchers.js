...
exports.watchActions = exports.watchVideosMusic = exports.watchSetMusic = exports.watchSetSfx = exports.watchSetBg = exports.watchSetGlobal = exports.watchSetAll = void 0;
...
function watchVideosMusic(action) {
    var payload;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
exports.watchVideosMusic = watchVideosMusic;
function watchActions() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                _a.sent();
                return [4 /*yield*/, (0, effects_1.takeLatest)(slice_1.actions.setVideos, watchVideosMusic)];
            case 6:
                _a.sent();
                return [2 /*return*/];
        }
