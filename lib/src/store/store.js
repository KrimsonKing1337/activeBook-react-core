...
var sound_1 = require("./effects/audio/sound");
var soundBg_1 = require("./effects/audio/soundBg");
var music_1 = require("./effects/audio/music");
...
var reducer = {
    ...
    soundEffects: sound_1.soundEffectsReducer,
    soundBgEffects: soundBg_1.soundBgEffectsReducer,
    musicEffects: music_1.musicEffectsReducer,
...
sagaMiddleware.run(sound_1.watchSoundEffectsActions);
sagaMiddleware.run(soundBg_1.watchSoundBgEffectsActions);
sagaMiddleware.run(music_1.watchMusicEffectsActions);
