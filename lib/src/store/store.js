...
var background_1 = require("./effects/background");
var font_1 = require("./effects/font");
...
var reducer = {
    ...
    backgroundEffects: background_1.backgroundEffectsReducer,
    fontEffects: font_1.fontEffectsReducer,
    bookmarks: bookmarks_1.bookmarksReducer,
    achievements: achievements_1.achievementsReducer,
    segments: segments_1.segmentsReducer,
...
sagaMiddleware.run(common_1.watchEffectsActions);
...
sagaMiddleware.run(background_1.watchBackgroundEffectsActions);
sagaMiddleware.run(segments_1.watchSegmentsActions);
