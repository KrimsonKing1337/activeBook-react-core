...
export declare const actions: import("@reduxjs/toolkit").CaseReducerActions<{
    ...
    setFontSize(state: import("immer").WritableDraft<State>, action: PayloadAction<State["fontSize"]>): void;
    setLineHeight(state: import("immer").WritableDraft<State>, action: PayloadAction<State["lineHeight"]>): void;
