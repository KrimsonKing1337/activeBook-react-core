...
export declare function watchSetAll(action: PayloadAction<State>): Generator<import("redux-saga/effects").CallEffect<void> | import("redux-saga/effects").SelectEffect | import("redux-saga/effects").PutEffect<{
    payload: boolean;
