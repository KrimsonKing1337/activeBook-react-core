...
function saveInLocalStorage() {
    var config, configToSave, configAsJson;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, select(selectors.all)];
            case 1:
                config = _a.sent();
                configToSave = __assign(__assign({}, config), { themes: undefined });
                delete configToSave.themes;
                configAsJson = JSON.stringify(configToSave);
...
export function watchSetAll(action) {
    var payload, theme, fontSize, flashlight, vibration, lineHeight, authorComments, themes;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 5:
                _a.sent();
                return [4 /*yield*/, select(selectors.themes)];
            case 6:
                themes = _a.sent();
                return [4 /*yield*/, call(function () { return setThemeCss(theme, themes); })];
            case 7:
                _a.sent();
                return [2 /*return*/];
        }
...
export function watchSetTheme(action) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                themes = _a.sent();
                return [4 /*yield*/, call(function () { return setThemeCss(payload, themes); })];
            case 2:
                _a.sent();
