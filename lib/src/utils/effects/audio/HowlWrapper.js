...
var HowlWrapper = /** @class */ (function () {
    function HowlWrapper(_a) {
        var id = _a.id, page = _a.page, src = _a.src, loop = _a.loop, _b = _a.type, type = _b === void 0 ? 'sfx' : _b, _c = _a.isRange, isRange = _c === void 0 ? false : _c, _d = _a.playOnLoad, playOnLoad = _d === void 0 ? false : _d, _e = _a.relativeVolume, relativeVolume = _e === void 0 ? 100 : _e, _f = _a.screamer, screamer = _f === void 0 ? false : _f, _g = _a.fadeOutWhenUnload, fadeOutWhenUnload = _g === void 0 ? true : _g, _h = _a.delay, delay = _h === void 0 ? 0 : _h, _j = _a.stopBy, stopBy = _j === void 0 ? 0 : _j, _k = _a.onPlay, onPlay = _k === void 0 ? function () { } : _k, _l = _a.onUnload, onUnload = _l === void 0 ? function () { } : _l, _m = _a.onPause, onPause = _m === void 0 ? function () { } : _m, _o = _a.onStop, onStop = _o === void 0 ? function () { } : _o;
        this.src = '';
        this.type = 'sfx';
        this.isRange = false;
        ...
        this.isFading = false;
        var _p = this.getVolume(), sfx = _p.sfx, bg = _p.bg, music = _p.music, global = _p.global;
    ...
    HowlWrapper.prototype.play = function () {
        return __awaiter(this, arguments, void 0, function (withFadeIn) {
            var _this = this;
    ...
    HowlWrapper.prototype.pause = function () {
        return __awaiter(this, arguments, void 0, function (withFadeOut) {
            var volume;
    ...
    HowlWrapper.prototype.stop = function () {
        return __awaiter(this, arguments, void 0, function (withFadeOut) {
            var volume;
            if (withFadeOut === void 0) { withFadeOut = false; }
            return __generator(this, function (_a) {
