...
var HowlWrapper = /** @class */ (function () {
    function HowlWrapper(_a) {
        var id = _a.id, page = _a.page, src = _a.src, loop = _a.loop, _b = _a.type, type = _b === void 0 ? 'sfx' : _b, _c = _a.playOnLoad, playOnLoad = _c === void 0 ? false : _c, _d = _a.relativeVolume, relativeVolume = _d === void 0 ? 100 : _d, _e = _a.screamer, screamer = _e === void 0 ? false : _e, _f = _a.fadeOutWhenUnload, fadeOutWhenUnload = _f === void 0 ? true : _f, _g = _a.delay, delay = _g === void 0 ? 0 : _g, _h = _a.stopBy, stopBy = _h === void 0 ? 0 : _h, _j = _a.onPlay, onPlay = _j === void 0 ? function () {
