...
function useSound(_a) {
    ...
    var howlInstances = (0, store_1.useSelector)(sound_1.soundEffectsSelectors.howlInstances);
    var _l = (0, react_1.useState)(''), id = _l[0], setId = _l[1];
            ...
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            _a.sent();
                            dispatch(sound_1.soundEffectsActions.deleteSound(id));
                            if (timer) {
                                clearTimeout(timer);
                            }
                            return [2 /*return*/];
