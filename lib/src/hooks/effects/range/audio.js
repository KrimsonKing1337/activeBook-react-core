...
function useAudioInRange(effects) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        var audiosOnPage = (0, rangeEffects_1.getEffectsInRange)(effects, page, 'audio');
        Object.keys(audioInstances).forEach(function (keyCur) {
            ...
            (function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, waitTillTheEndIfAudioIsTooShort_1.waitTillTheEndIfAudioIsTooShort)(audioInstanceCur)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
