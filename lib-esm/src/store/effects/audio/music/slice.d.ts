...
export declare const actions: import("@reduxjs/toolkit").CaseReducerActions<{
    setMusic(_state: import("immer/dist/internal").WritableDraft<State>, _action: PayloadAction<HowlInst>): void;
...
}, "@effects/audio/music">, reducer: import("redux").Reducer<State>;
