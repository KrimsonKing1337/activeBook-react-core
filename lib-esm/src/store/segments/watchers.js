    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, select(selectors.segments)];
            case 1:
                segments = _a.sent();
...
export function watchRemoveSegment(action) {
...
export function watchIncrementSegmentsCount() {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                count = _a.sent();
                return [4 /*yield*/, put(actions.setSegmentsCount(count + 1))];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
export function watchActions() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, takeLatest(actions.setSegment, watchSetSegment)];
            case 1:
                _a.sent();
                return [4 /*yield*/, takeLatest(actions.removeSegment, watchRemoveSegment)];
            case 2:
                _a.sent();
                return [4 /*yield*/, takeLatest(actions.incrementSegmentsCount, watchIncrementSegmentsCount)];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
