...
var HowlWrapper = /** @class */ (function () {
    function HowlWrapper(_a) {
        var id = _a.id, src = _a.src, loop = _a.loop, _b = _a.type, type = _b === void 0 ? 'sfx' : _b, _c = _a.screamer, screamer = _c === void 0 ? false : _c, _d = _a.onPlay, onPlay = _d === void 0 ? function () {
        } : _d;
        this.id = undefined;
        this.src = '';
    ...
    HowlWrapper.prototype.unload = function (withFadeOut) {
        if (withFadeOut === void 0) { withFadeOut = false; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
