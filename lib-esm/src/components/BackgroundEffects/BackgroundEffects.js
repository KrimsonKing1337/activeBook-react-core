...
export var BackgroundEffects = function () {
    ...
    return Object.keys(effects).map(function (keyCur) {
        ...
        var uuid = nanoid();
        return (_jsxs("div", { style: style, className: styles.backgroundEffectsWrapper, children: [_jsx(Dots, {}), oneOfBgIsActive && (_jsxs("div", { className: styles.backgroundObjectsWrapper, children: [_jsx(Shadow, { options: shadow }), Component, _jsx(Videos, { videos: videos }), _jsx(Images, { images: images })] }))] }, uuid));
    });
};
